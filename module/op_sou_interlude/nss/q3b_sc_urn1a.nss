// has a ruby and did not place anything else in the urn
...
int StartingConditional()
{
    ...
    // and if the player has the component - AND has already placed a ruby inside return true
    if(GetItemPossessedBy(GetPCSpeaker(), "NW_IT_GEM006") != OBJECT_INVALID
        &&
       GetItemPossessedBy(OBJECT_SELF, "NW_IT_GEM006") != OBJECT_INVALID)
        return TRUE;
    return FALSE;
}
