// has Fairy Dust and did not place anything else in the urn
...
int StartingConditional()
{
    ...
    if(GetItemPossessedBy(GetPCSpeaker(), "NW_IT_MSMLMISC19") != OBJECT_INVALID
        &&
       GetItemPossessedBy(OBJECT_SELF, "NW_IT_MSMLMISC19") != OBJECT_INVALID)
        return TRUE;
    return FALSE;
}
