// has a Slaadi tongue and did not place anything else in the urn
...
int StartingConditional()
{
    ...
    // and if the player has the component - AND placed some inside return true
    if(GetItemPossessedBy(GetPCSpeaker(), "NW_IT_MSMLMISC10") != OBJECT_INVALID
        &&
       GetItemPossessedBy(OBJECT_SELF, "NW_IT_MSMLMISC10") != OBJECT_INVALID)
        return TRUE;
    return FALSE;
}
