...
void main()
{
    ...
    SetLocalFloat(oSource1, "Q2_FIRE_DELAY", 0.0);
    SetLocalFloat(oSource2, "Q2_FIRE_DELAY", 0.0);
    SetLocalFloat(oSource3, "Q2_FIRE_DELAY", 0.0);
    SetLocalFloat(oSource4, "Q2_FIRE_DELAY", 0.0);
    SetLocalFloat(oSource5, "Q2_FIRE_DELAY", 0.0);
    SetLocalFloat(oSource6, "Q2_FIRE_DELAY", 0.0);
    SetLocalFloat(oSource7, "Q2_FIRE_DELAY", 0.0);
    SetLocalFloat(oSource8, "Q2_FIRE_DELAY", 0.0);
