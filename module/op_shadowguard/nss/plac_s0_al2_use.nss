...
void main()
{
    ...
    if (GetIsPC(oPC))
    {
        ...
        else if (GetSkillRank(SKILL_DISABLE_TRAP, oPC) >= nDifficulty + 2)
        {
            ...
            SceneSpeak(oPC, "[This altar appears to be activating the shields guarding the Heart of Rakha, but you cannot discern a way to disrupt the magical forces at work, short of possibly bashing the stone block into pieces...]");
    }
}
