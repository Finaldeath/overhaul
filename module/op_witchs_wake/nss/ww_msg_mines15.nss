//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #15
//:: WW_Msg_Mines15.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'I wear a ring of gold upon my finger. Does it mean I have a "+
                     "wife who pines for my return? Will I recognize her "+
                     "face, the touch of her hand? Or is it a symbol of some "+
                     "battle fought or loyalty shared? Or is it just a golden "+
                     "ring, a trinket picked up along the journey?'";
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_15", TRUE);
                //Send Check feedback.
                ...
                //Play GUI sound
                object oVoice = GetNearestObjectByTag("ww1_narrator177", oEnterer);
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage15";
