...
//:://////////////////////////////////////////////
/*
    Creates a 9d4 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int i8d4 = Random(4)+1;
    int i9d4 = Random(4)+1;
    int iTotal = i1d4 + i2d4 + i3d4 + i4d4 + i5d4 + i6d4 + i7d4 + i8d4 + i9d4;
    ...
    string sBroadcast = sName+" rolls 9d4 ("+s1d4+", "+s2d4+", "+s3d4+", "+s4d4+", "+s5d4+", "+s6d4+", "+s7d4+", "+s8d4+", "+s9d4+"): TOTAL = "+sTotal+".";
