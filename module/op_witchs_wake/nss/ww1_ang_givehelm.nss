//::///////////////////////////////////////////////
//:: Witchwork 1: Angmar, Give Helm
//:: WW1_Ang_GiveHelm.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Angmar destroys the rusted helm and gives the
...
void main()
{
    ...
    object oHelm = GetItemPossessedBy(OBJECT_SELF, "ww1_gravehelm");
    object oHammer = GetItemPossessedBy(OBJECT_SELF, "NW_WBLHW001");

    //Destroy the rusted helm
    DestroyObject(oHelm);

    //Create a polished helm in the player's inventory
    CreateItemOnObject("ww1_gravehelm_p", oPC);
...
//////Give this XP Reward a unique Tag. No default.
    string sRewardTag = "XP_AC_GraveHelmHaunted";
