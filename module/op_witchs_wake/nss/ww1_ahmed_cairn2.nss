//::///////////////////////////////////////////////
//:: Witchwork 1: Ahmed's Cairn, Second Stone
//:: WW1_Ahmed_Cairn2.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Creates the second cairn stone for Ahmed's
     burial
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    object oCairnStones2 = GetObjectByTag("CairnStones2");
    location lCairnStones2 = GetLocation(oCairnStones2);
    vector vCairnStones2 = GetPositionFromLocation(lCairnStones2);
    float fCairnStones2 = GetFacingFromLocation(lCairnStones2);
    location lNewCairnStone = Location(oArea, vCairnStones2, fCairnStones2);
...
//////Give this XP Reward a unique Tag. No default.
    string sRewardTag = "XP_RO_AhmedCairn2";
