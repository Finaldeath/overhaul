//::///////////////////////////////////////////////
//:: Witchwork 1: Angmar, Give Sword
//:: WW1_Ang_GiveSword.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Angmar destroys the rusted Sowrd and gives
     the player a polished one.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    object oSword = GetItemPossessedBy(OBJECT_SELF, "ww1_gravesword");
    object oHammer = GetItemPossessedBy(OBJECT_SELF, "NW_WBLHW001");

    //Destroy the rusted sword
    DestroyObject(oSword);

    //Create a polished sword in the player's inventory
    CreateItemOnObject("ww1_gravesword_p", oPC);
...
//////Give this XP Reward a unique Tag. No default.
    string sRewardTag = "XP_AC_GraveSwordElven";
