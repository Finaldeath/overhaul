//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #8
//:: WW_Msg_Mines08.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'The others will come for me. The Prince said he knew "+
                     "I would be in danger and that he had a plan. He "+
                     "promised me that someone would be sent.'";
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_8", TRUE);
                //Send Check feedback.
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage08";
