//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #12
//:: WW_Msg_Mines12.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'The rats are everywhere. Have they always been? I "+
                     "don't think so... but I don't know. Why can't I think "+
                     "straight?'";
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_12", TRUE);
                //Send Check feedback.
                ...
                //Play GUI sound
                object oVoice = GetNearestObjectByTag("ww1_narrator174", oEnterer);
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage12";
