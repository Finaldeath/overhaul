//::///////////////////////////////////////////////
//:: Witchwork: Stygian Bloodhound UserDefined
//:: WW_Stygia_Bloodh.nss
//:: Copyright (c) 2002 Bioware Corp.
//:://////////////////////////////////////////////
/*
    Spawns in a Gargenfiend to replace the Stygian
    Bloodhound.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    switch (iUDNum)
    {
        ...
        case 1007: //User-Defined OnDeath Event
        {
            ...
            //Create a Gargenfiend to replace the Stygian Bloodhound
            object oStygian = CreateObject(OBJECT_TYPE_CREATURE, "ww_sty_gargenfie", lSpawn, TRUE);
