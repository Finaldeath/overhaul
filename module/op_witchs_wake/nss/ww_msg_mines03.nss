//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #3
//:: WW_Msg_Mines03.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'I stayed behind to steal the Cavanaugh Stone. The "+
                     "others have gone north. Soon we will be able to make "+
                     "the journey home.'";
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_3", TRUE);
                //Send Check feedback.
                ...
                //Play GUI sound
                object oVoice = GetNearestObjectByTag("ww1_narrator165", oEnterer);
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage03";
