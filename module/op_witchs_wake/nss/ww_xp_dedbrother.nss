//::///////////////////////////////////////////////
//:: Witchwork: XP Reward (Bernhardt's Dead Brother)
//:: WW_XP_DeadBrother.nss
...
void main()
{
    ...
    SetLocalInt(oPC, "CONV_BERNHARDT_DeadBrother", TRUE);
...
//////Give this XP Reward a unique Tag. No default.
    string sRewardTag = "XP_KN_BernsDeadBrother";
