//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #10
//:: WW_Msg_Mines10.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'What am I doing here? I was supposed to write "+
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_10", TRUE);
                //Send Check feedback.
                ...
                //Play GUI sound
                object oVoice = GetNearestObjectByTag("ww1_narrator172", oEnterer);
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage10";
