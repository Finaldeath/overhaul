...
//:://////////////////////////////////////////////
/*
    Creates a 7d8 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int i6d8 = Random(8)+1;
    int i7d8 = Random(8)+1;
    int iTotal = i1d8 + i2d8 + i3d8 + i4d8 + i5d8 + i6d8 + i7d8;
    ...
    string sBroadcast = sName+" rolls 7d8 ("+s1d8+", "+s2d8+", "+s3d8+", "+s4d8+", "+s5d8+", "+s6d8+", "+s7d8+"): TOTAL = "+sTotal+".";
