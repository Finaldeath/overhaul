...
//:://////////////////////////////////////////////
/*
    Creates a 10d10 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int i10d10 = Random(10)+1;
    int iTotal = i1d10 + i2d10 + i3d10 + i4d10 + i5d10 + i6d10 + i7d10 + i8d10 + i9d10 + i10d10;
    ...
    string s10d10 = IntToString(i10d10);
    string sTotal = IntToString(iTotal);

    //Compile the string to be broadcast and save it out as a local
    string sBroadcast = sName+" rolls 10d10 ("+s1d10+", "+s2d10+", "+s3d10+", "+s4d10+", "+s5d10+", "+s6d10+", "+s7d10+", "+s8d10+", "+s9d10+", "+s10d10+"): TOTAL = "+sTotal+".";
