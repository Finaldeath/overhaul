...
//:://////////////////////////////////////////////
/*
    Creates a 6d20 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int iTotal = i1d20 + i2d20 + i3d20 + i4d20 + i5d20 + i6d20;
    ...
    string sBroadcast = sName+" rolls 6d20 ("+s1d20+", "+s2d20+", "+s3d20+", "+s4d20+", "+s5d20+", "+s6d20+"): TOTAL = "+sTotal+".";
