...
//:://////////////////////////////////////////////
/*
    Creates a 10d8 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int i8d8 = Random(8)+1;
    int i9d8 = Random(8)+1;
    int i10d8 = Random(8)+1;
    int iTotal = i1d8 + i2d8 + i3d8 + i4d8 + i5d8 + i6d8 + i7d8 + i8d8 + i9d8 + i10d8;
    ...
    string s10d8 = IntToString(i10d8);
    string sTotal = IntToString(iTotal);

    //Compile the string to be broadcast and save it out as a local
    string sBroadcast = sName+" rolls 10d8 ("+s1d8+", "+s2d8+", "+s3d8+", "+s4d8+", "+s5d8+", "+s6d8+", "+s7d8+", "+s8d8+", "+s9d8+", "+s10d8+"): TOTAL = "+sTotal+".";
