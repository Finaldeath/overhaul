//::///////////////////////////////////////////////
//:: Witchwork: Stygia Gargenfiend UserDefined
//:: WW_Stygia_Gargen.nss
//:: Copyright (c) 2002 Bioware Corp.
//:://////////////////////////////////////////////
/*
    Spawns in a Succubus to replace the
    Gargenfiend.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    switch (iUDNum)
    {
        ...
        case 1007: //User-Defined OnDeath Event
        {
            ...
            //Create a Succubus to replace the Gargenfiend
            object oStygian = CreateObject(OBJECT_TYPE_CREATURE, "ww_sty_succubus", lSpawn, TRUE);
