//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #9
//:: WW_Msg_Mines09.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'I don't remember home anymore, only that I miss it. We "+
                     "took the long way here, following the winding route set "+
                     "by our quarry. The western route will get us home "+
                     "sooner.'";
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_9", TRUE);
                //Send Check feedback.
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage09";
