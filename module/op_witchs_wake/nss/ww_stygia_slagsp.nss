//::///////////////////////////////////////////////
//:: Witchwork: Stygia Slag Spitter UserDefined
//:: WW_Stygia_SlagSp.nss
//:: Copyright (c) 2002 Bioware Corp.
//:://////////////////////////////////////////////
/*
    Spawns in a Hellion to replace the Slag
    Spitter.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    switch (iUDNum)
    {
        ...
        case 1007: //User-Defined OnDeath Event
        {
            ...
            //Create a Hellion to replace the Slag Spitter
            object oStygian = CreateObject(OBJECT_TYPE_CREATURE, "ww_sty_hellion", lSpawn, TRUE);
