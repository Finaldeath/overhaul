...
//:://////////////////////////////////////////////
/*
    Creates a 7d6 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int i6d6 = Random(6)+1;
    int i7d6 = Random(6)+1;
    int iTotal = i1d6 + i2d6 + i3d6 + i4d6 + i5d6 + i6d6 + i7d6;
    ...
    string sBroadcast = sName+" rolls 7d6 ("+s1d6+", "+s2d6+", "+s3d6+", "+s4d6+", "+s5d6+", "+s6d6+", "+s7d6+"): TOTAL = "+sTotal+".";
