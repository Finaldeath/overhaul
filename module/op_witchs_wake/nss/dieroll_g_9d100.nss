...
//:://////////////////////////////////////////////
/*
    Creates a 9d100 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int iTotal = i1d100 + i2d100 + i3d100 + i4d100 + i5d100 + i6d100 + i7d100 + i8d100 + i9d100;
    ...
    string sBroadcast = sName+" rolls 9d100 ("+s1d100+", "+s2d100+", "+s3d100+", "+s4d100+", "+s5d100+", "+s6d100+", "+s7d100+", "+s8d100+", "+s9d100+"): TOTAL = "+sTotal+".";
