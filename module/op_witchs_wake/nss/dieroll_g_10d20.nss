...
//:://////////////////////////////////////////////
/*
    Creates a 10d20 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int i8d20 = Random(20)+1;
    int i9d20 = Random(20)+1;
    int i10d20 = Random(20)+1;
    int iTotal = i1d20 + i2d20 + i3d20 + i4d20 + i5d20 + i6d20 + i7d20 + i8d20 + i9d20 + i10d20;
    ...
    string s8d20 = IntToString(i8d20);
    string s9d20 = IntToString(i9d20);
    string s10d20 = IntToString(i10d20);
    string sTotal = IntToString(iTotal);

    //Compile the string to be broadcast and save it out as a local
    string sBroadcast = sName+" rolls 10d20 ("+s1d20+", "+s2d20+", "+s3d20+", "+s4d20+", "+s5d20+", "+s6d20+", "+s7d20+", "+s8d20+", "+s9d20+", "+s10d20+"): TOTAL = "+sTotal+".";
