//::///////////////////////////////////////////////
//:: Witchwork: Stygia Tymbra'lane UserDefined
//:: WW_Stygia_Tymbra.nss
//:: Copyright (c) 2002 Bioware Corp.
//:://////////////////////////////////////////////
/*
    Spawns in a Carpoloth to replace the
    Tymbra'lane.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    switch (iUDNum)
    {
        ...
        case 1007: //User-Defined OnDeath Event
        {
            ...
            //Create a Carpoloth to replace the Tymbra'lane
            object oStygian = CreateObject(OBJECT_TYPE_CREATURE, "ww_sty_carpoloth", lSpawn, TRUE);
