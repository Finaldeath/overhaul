//::///////////////////////////////////////////////
//:: Witchwork: XP Reward (What Bernhardt Would Tell His Brother
//:: WW_XP_BernBroMsg.nss
...
void main()
{
    ...
    SetLocalInt(oPC, "CONV_BERNHARDT_TellBrother", TRUE);
...
//////Give this XP Reward a unique Tag. No default.
    string sRewardTag = "XP_KN_MsgForBernsBro";
