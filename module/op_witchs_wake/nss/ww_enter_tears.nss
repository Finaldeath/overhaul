//::///////////////////////////////////////////////
//:: Witchwork: Brogan's Tears OnEnter
//:: WW_Enter_Tears.nss
...
void main()
{
    ...
    //Update journal entry, provided players took the translated message route.
    int iTearsMessage = GetLocalInt(oEnterer, "NW_JOURNAL_ENTRYWW_TearsUntranslated");
    if (iTearsMessage != 0)
    {
        AddJournalQuestEntry("WW_TearsUntranslated", 30, oEnterer, FALSE);
    }
...
//////Give this XP Reward a unique Tag. No default.
    string sRewardTag = "XP_EX_BrogansTears";
