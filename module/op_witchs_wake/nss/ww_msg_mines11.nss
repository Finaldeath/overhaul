//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #11
//:: WW_Msg_Mines11.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'Long ride the Witch Hunters and longer be their "+
                     "journey home.'";
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_11", TRUE);
                //Send Check feedback.
                ...
                //Play GUI sound
                object oVoice = GetNearestObjectByTag("ww1_narrator173", oEnterer);
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage11";
