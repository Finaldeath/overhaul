//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #16
//:: WW_Msg_Mines16.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'My arrows fly gracelessly to their targets and my "+
                     "blades feel awkward in my hands. When I look at my body "+
                     "in the torchlight, though, I see the scars of countless "+
                     "battles... There was a time I was something more than "+
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_16", TRUE);
                //Send Check feedback.
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage16";
