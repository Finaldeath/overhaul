//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #6
//:: WW_Msg_Mines06.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'I've been captured by Barrow Dwarves and thrown into "+
                     "this mine. Morrius called them an evil and backward "+
                     "clan but I don't remember why.'";
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_6", TRUE);
                //Send Check feedback.
                ...
                //Play GUI sound
                object oVoice = GetNearestObjectByTag("ww1_narrator168", oEnterer);
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage06";
