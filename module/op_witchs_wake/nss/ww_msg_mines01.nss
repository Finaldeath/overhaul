//::///////////////////////////////////////////////
//:: Witchwork: Trigger Message, Mines Scrawl #1
//:: WW_Msg_Mines01.nss
...
void main()
{
    ...
    string sString = "A chalk message looms out of the darkness like a ghost: "+
                     "'I'm forgetting things. I can actually *feel* the "+
                     "memories slip away... I must write everything down, "+
        ...
        bSeenOnce == FALSE)
    {
        ...
        if (iCheck >= iDC)
        {
            ...
            if (bSound == FALSE)
            {
                ...
                SetLocalInt(oEnterer, "MSG_MINE_SCRAWL_1", TRUE);
                //Send Check feedback.
                ...
                //Play GUI sound
                object oVoice = GetNearestObjectByTag("ww1_narrator164", oEnterer);
            ...
            //////Give this XP Reward a unique Tag. No default.
                string sRewardTag = "XP_KN_MinesMessage01";
