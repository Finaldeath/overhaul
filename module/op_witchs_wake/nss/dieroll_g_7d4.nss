...
//:://////////////////////////////////////////////
/*
    Creates a 7d4 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int i6d4 = Random(4)+1;
    int i7d4 = Random(4)+1;
    int iTotal = i1d4 + i2d4 + i3d4 + i4d4 + i5d4 + i6d4 + i7d4;
    ...
    string sBroadcast = sName+" rolls 7d4 ("+s1d4+", "+s2d4+", "+s3d4+", "+s4d4+", "+s5d4+", "+s6d4+", "+s7d4+"): TOTAL = "+sTotal+".";
