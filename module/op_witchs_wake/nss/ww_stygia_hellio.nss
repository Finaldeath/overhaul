//::///////////////////////////////////////////////
//:: Witchwork: Stygia Hellion UserDefined
//:: WW_Stygia_Hellio.nss
//:: Copyright (c) 2002 Bioware Corp.
//:://////////////////////////////////////////////
/*
    Spawns in a Stygian Bloodhound to replace the
    Hellion.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    switch (iUDNum)
    {
        ...
        case 1007: //User-Defined OnDeath Event
        {
            ...
            //Create a Stygian Bloodhound to replace the Hellion
            object oStygian = CreateObject(OBJECT_TYPE_CREATURE, "ww_sty_stygianho", lSpawn, TRUE);
