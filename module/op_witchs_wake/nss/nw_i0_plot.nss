...
//:: Custom version made by Rob Bartel for WW1 Remastered.
//::    -> Stripped low intelligence conv options from
//::       the module [see the CheckIntelligence() functions].
...
// Changed by Rob Bartel for WW1: Remastered so that it always returns FALSE.
...
// Changed by Rob Bartel for WW1: Remastered so that it always returns TRUE.
