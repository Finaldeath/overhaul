...
//:://////////////////////////////////////////////
/*
    Creates a 9d6 broadcast string.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int i8d6 = Random(6)+1;
    int i9d6 = Random(6)+1;
    int iTotal = i1d6 + i2d6 + i3d6 + i4d6 + i5d6 + i6d6 + i7d6 + i8d6 + i9d6;
    ...
    string sBroadcast = sName+" rolls 9d6 ("+s1d6+", "+s2d6+", "+s3d6+", "+s4d6+", "+s5d6+", "+s6d6+", "+s7d6+", "+s8d6+", "+s9d6+"): TOTAL = "+sTotal+".";
