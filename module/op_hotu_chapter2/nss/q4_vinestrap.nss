...
void main()
{
    effect eAOE = EffectAreaOfEffect(AOE_PER_FOGSTINK, "q4_s0_firefoga", "q4_s0_firefogc", "q4_s0_firefogb");
    ...
    float fDistance;
    object oWP = GetNearestObjectByTag("q4_wp_vine_trap", OBJECT_SELF, i);
    while(oWP != OBJECT_INVALID)
    {
        ...
        ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, eAOE, GetLocation(oWP), RoundsToSeconds(20));
        i++;
        oWP = GetNearestObjectByTag("q4_wp_vine_trap", OBJECT_SELF, i);
    }
