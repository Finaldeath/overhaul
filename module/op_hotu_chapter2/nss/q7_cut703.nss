// Second interjection cutscene (matron speeks with meph)

#include "x2_inc_cutscene"
int CUTSCENE_NUMBER = 703;
string DIALOG_NAME = "q7_cut_val0b";
...
void main()
{
    ...
    SetLocalObject(GetModule(), "X2_CUT703_PC", oPC); // used inside the dialog to get the pc
