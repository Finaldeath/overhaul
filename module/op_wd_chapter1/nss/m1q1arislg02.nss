...
void main()
{
    ...
    SetLocalInt(GetModule(),"NW_G_M1Q01PLOT_PRISONDISTRICT",TRUE);
    SetCustomToken(100,GetName(oSpeaker));
    SetLocalObject(OBJECT_SELF,"NW_L_oPrimary",oSpeaker);
    SetLocalObject(GetModule(),"NW_G_M1Q2Returnee",oSpeaker);

    ActionPauseConversation();
    DestroyObject(GetItemPossessedBy(oSpeaker,"M1Q2PlotReagent"));
