//::///////////////////////////////////////////////
//:: H2 Stone Trigger, Wrong Stone (OnEnter)
//:: H2_En_StoneWrong.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Marks the player as having approached the
     wrong stone in the Scrivener's Rebus puzzle
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    if (GetIsPC(oEnterer) == TRUE)
    {
        ...
        //Flag them as being at the base of the wrong stone.
        SetLocalInt(oScrivener, "bWrongStone", TRUE);
