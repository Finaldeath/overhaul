//////////////////////////////////////////////////////////////////////////////////
// This is for the ending switch (closest to the lightning door). We don't want
// a spinning arrow here, so it will always jump the PC to the same spot.
//
...
void main()
{
   ...
   location lDest = GetLocation(GetWaypointByTag("end_destination"));
