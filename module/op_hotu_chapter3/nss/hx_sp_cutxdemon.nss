...
void main()
{
    ...
    */
    ...
    location lLoc = GetLocation(GetObjectByTag("hx_cutx_demon_endmove_wp"));
    object oInvis = GetObjectByTag("hx_invis_cut_bash");

    SignalEvent(oInvis, EventUserDefined(4444));
    DelayCommand(0.5, ActionMoveToLocation(GetLocation(GetObjectByTag("hx_demon_cutx_move")), TRUE));
    DelayCommand(2.0, DoPlaceableObjectAction(oInvis, PLACEABLE_ACTION_BASH));
}
