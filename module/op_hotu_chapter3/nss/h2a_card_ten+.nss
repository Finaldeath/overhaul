//::///////////////////////////////////////////////
//:: Hellbreath Tavern Card Trick, Is Card Greater Than Ten? (Action Script)
//:: H2a_Card_Ten+.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Determines whether or not the card is greater
     than a Ten and whether or not the NPC is
...
void main()
{
    ...
    //The last two digits determine if it's greater than a Ten
