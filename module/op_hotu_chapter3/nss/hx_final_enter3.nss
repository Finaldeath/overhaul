...
void TeleportParty(location lLoc, object oObject, int iCut);
// Clear effects.
...
void StartCutscene(object oPC, int iCut)
{
      ...
      object oSound5 = GetNearestObjectByTag("hx_durnan_tp", oPC);
      CutSetActiveCutsceneForObject(oSound5, iCut);
      object oSound6 = GetNearestObjectByTag("hx_durnan_cast_tp", oPC);
      CutSetActiveCutsceneForObject(oSound6, iCut);

      // Demon Hand.
      object oSound7 = GetNearestObjectByTag("hx_demon_cast_sound", oPC);
      CutSetActiveCutsceneForObject(oSound7, iCut);
      object oSound8 = GetNearestObjectByTag("hx_demon_land_sound", oPC);
      CutSetActiveCutsceneForObject(oSound8, iCut);
      ...
      //CutJumpToLocation(6.2, oPC, lPCMove1);
      CutSetCamera(6.5, oPC, CAMERA_MODE_TOP_DOWN, 100.0, 17.0, 86.0,
                   CAMERA_TRANSITION_TYPE_SNAP);
      CutActionMoveToLocation(6.2, oMeph, lMephMove, FALSE);

      //CutActionStartConversation(6.5, oDurnan, oDurnan, "h9_durnan");
      CutPlaySound(3.5, oDurnan, "vs_nx2durnm_58");
      ...
      CutSetFacingPoint(6.1, oDurnan, "hx_meph");
      CutSetFacingPoint(6.5, oPCCopy, "hx_meph");

      CutApplyEffectAtLocation(10.0, oPC, DURATION_TYPE_INSTANT, VFX_IMP_UNSUMMON, GetLocation(oDurnan));
      CutApplyEffectAtLocation(10.2, oPC, DURATION_TYPE_INSTANT, VFX_FNF_SUMMON_UNDEAD, GetLocation(oDurnan));
      // Durnan gets teleported out.
      CutActionStartConversation(7.5, oDurnan, oDurnan, "h9_durnan");

      CutActionCastFakeSpellAtObject(7.9, SPELL_DISPEL_MAGIC, oCaster, oDurnan);
      DelayCommand(8.0, CutPlaySoundObject(iCut, oSound6));

      CutClearAllActions(8.2, oDurnan, TRUE);
      DelayCommand(10.0, CutPlaySoundObject(iCut, oSound5));
      //CutJumpToLocation(10.2, oDurnan, lDurnan);
      CutSetCamera(9.8, oPC, CAMERA_MODE_TOP_DOWN, 82.0, 16.5, 86.0,
                   CAMERA_TRANSITION_TYPE_VERY_SLOW);
      CutApplyEffectToObject(10.4, DURATION_TYPE_PERMANENT, VFX_DUR_CUTSCENE_INVISIBILITY, oDurnan, 10.0);
      CutDestroyObject(15.5, oDurnan);
      CutActionCastFakeSpellAtObject(12.2, 793, oPCCopy, oInvis);
      DelayCommand(13.0, CutPlaySoundObject(iCut, oSound7));
      //CutActionCastSpellAtObject(12.2, 793, oPCCopy, oInvis, METAMAGIC_ANY, TRUE, 0, PROJECTILE_PATH_TYPE_DEFAULT, TRUE);
      CutJumpToLocation(14.5, oPCCopy, lGrapple);
      CutApplyEffectToObject(13.6, DURATION_TYPE_INSTANT, VFX_IMP_FLAME_M, oPCCopy);
      CutApplyEffectToObject(14.3, DURATION_TYPE_INSTANT, 475, oInvis);
      CutJumpToLocation(14.2, oPC, lPCMove3);
      CutSetCamera(14.2, oPC, CAMERA_MODE_TOP_DOWN, 20.0, 20.0, 60.0,
                   CAMERA_TRANSITION_TYPE_SNAP);
      DelayCommand(14.3, CutPlaySoundObject(iCut, oSound8));
      ...
      DelayCommand(22.6, TeleportParty(lHench, oPC, iCut));
