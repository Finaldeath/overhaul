//::///////////////////////////////////////////////
//:: H2 Stone Trigger, Treason Stone (OnEnter)
//:: H2_En_StoneTreas.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Marks the player as having approached the
     Treason stone in the Scrivener's Rebus puzzle
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    if (GetIsPC(oEnterer) == TRUE)
    {
        ...
        //Flag them as being at the base of the Treason stone.
        SetLocalInt(oScrivener, "bTreasonStone", TRUE);
