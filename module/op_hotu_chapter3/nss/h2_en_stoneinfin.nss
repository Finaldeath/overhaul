//::///////////////////////////////////////////////
//:: H2 Stone Trigger, Infinity Stone (OnEnter)
//:: H2_En_StoneInfin.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Marks the player as having approached the
     Infinity stone in the Scrivener's Rebus puzzle
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    if (GetIsPC(oEnterer) == TRUE)
    {
        ...
        //Flag them as being at the base of the Infinity stone.
        SetLocalInt(oScrivener, "bInfinityStone", TRUE);
