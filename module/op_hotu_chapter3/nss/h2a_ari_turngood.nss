//::///////////////////////////////////////////////
//:: Aribeth, Turn Good (Action Script)
//:: H2a_Ari_TurnGood.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Mini-cutscene where Aribeth becomes good.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    //Add journal entry
    AddJournalQuestEntry("XP2_Aribeth", 90, oPC, TRUE, TRUE);
...
void StartCutscene(object oPC, int iCut)
{
      ...
      // Start cutscene.
      CutSetCamera(2.2, oPC, CAMERA_MODE_TOP_DOWN, 360.0, 3.0, 55.0,
      ...
      CutApplyEffectToObject(5.3, DURATION_TYPE_INSTANT, VFX_FNF_STRIKE_HOLY, oAribeth);
      DelayCommand(6.0, ChangeSword(iCut, oAribeth, oWeapon));

      // End scene.
      CutFadeOutAndIn(10.0, oPC, 1.5);
      CutCreateObject(10.5, oPC, OBJECT_TYPE_CREATURE, "hx_aribeth_good", lSave, EFFECT_TYPE_INVALIDEFFECT);
