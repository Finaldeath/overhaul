...
void main()
{
    ...
    if (sMyTag == "x2_hen_nathyra" || sMyTag == "x2_hen_valen")
    {
        ...
        SetNumberOfRandom("X2_L_RANDOM_INTERJECTIONS", OBJECT_SELF, 3); // * Nathyrra seems to have three in c2
    }
    ...
    DelayCommand(0.5, AdjustAlignment(oSelf, ALIGNMENT_NEUTRAL, 100));
}
