//::///////////////////////////////////////////////
//:: Hellbreath Tavern Card Trick, Is Card Greater Than Two? (Action Script)
//:: H2a_Card_Two+.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Determines whether or not the card is greater
     than a Two and whether or not the NPC is
...
void main()
{
    ...
    //The last two digits determine if it's greater than a Two
