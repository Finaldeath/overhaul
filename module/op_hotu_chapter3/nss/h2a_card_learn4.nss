//::///////////////////////////////////////////////
//:: Hellbreath Tavern, Card Game, 4th-Fold Mystery Learned (Action Script)
//:: H2a_Card_Learn4.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Flags the fact that the player has learned
     the 4th-fold mystery of the Sleeping Man.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int bMystery = GetLocalInt(GetModule(), "bMystery4Learned");
    if (bMystery == FALSE)
    {
        ...
        AddJournalQuestEntry("XP2_Mystery4", 30, oPC, TRUE, TRUE);
