...
void main()
{
    ...
    */
    ...
    PlayAnimation(ANIMATION_LOOPING_DEAD_FRONT, 0.4, 2.2);
    DelayCommand(4.9, PlaySound("fs_flapfeather"));
    DelayCommand(5.0, ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDisappear(), OBJECT_SELF));
}
