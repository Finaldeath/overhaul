//::///////////////////////////////////////////////
//:: Githzerai Sensei, 3rd-Fold Mystery Lore Check (Condition Script)
//:: H2c_Sens_Lore_3.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Returns TRUE if the player passes the Lore
     check for the 3rd-Fold Mystery.
*/
//:://////////////////////////////////////////////
...
int StartingConditional()
{
    ...
    //result as last time.
    string sAttempt = GetLocalString(oPC, "sMystery3Attempt");
    if (sAttempt == "TRUE")
    {
        return TRUE;
    }
    ...
    else
    {
        ...
        //in the toolset. As this is the 3rd question, the DC is increased.
