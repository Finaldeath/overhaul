//::///////////////////////////////////////////////
//:: Hellbreath Tavern Card Trick, Is Card Black? (Action Script)
//:: H2a_Card_Black.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Determines whether or not the card is black
...
void main()
{
    ...
    //If the value is less than 300, it must be a black card.
    if (iCardDrawn < 300)
    {
        bBlack = TRUE;
    }
