//::///////////////////////////////////////////////
//:: Gru'ul the Quarry Boss, 1st-Fold Mystery Learned (Action Script)
//:: H2a_Gruul_Learn1.nss
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
     Flags the fact that the player has learned
     the 1st-fold mystery of the Sleeping Man.
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    int bMystery = GetLocalInt(GetModule(), "bMystery1Learned");
    if (bMystery == FALSE)
    {
        ...
        AddJournalQuestEntry("XP2_Mystery1", 20, oPC, TRUE, TRUE);
