...
void main()
{
    ...
    */
    ...
    object oMelee = GetItemInSlot(INVENTORY_SLOT_RIGHTHAND);
    object oRanged = GetFirstItemInInventory();

    SetLocalObject(OBJECT_SELF, "hx_melee", oMelee);
    SetLocalObject(OBJECT_SELF, "hx_ranged", oRanged);
}
