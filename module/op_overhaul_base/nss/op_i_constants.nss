...
const int SPELL_ITEM_FIREBOMB                             = 744;
const int SPELL_ITEM_ACIDBOMB                             = 745;
const int SPELLABILITY_SHADOWBLEND                        = 757;
const int SPELL_ITEM_PARALYZING_TOUCH_DEMILICH            = 758;
const int SPELLABILITY_HARM_SELF                          = 759;
const int SPELL_ITEM_PARALYZING_TOUCH_DRACOLICH           = 760;
