...
const int STRREF_CONCENTRATION_BROKEN_SUMMONED_CREATURE_DISPELLED = 84481; // * Concentration broken, summoned creature dispelled *
...
void SendImmunityFeedback(object oCaster, object oTarget, int nImmunityType)
{
    ...
    switch (nImmunityType)
    {
        ...
        case IMMUNITY_TYPE_FATIGUE: sMessage = "Fatigue"; break;
        ...
        case IMMUNITY_TYPE_NAUSEA: sMessage = "Nausea"; break;
        default:
        {
