    ...
    */
    if (nResult == 1 || nResult == 2)
    {
        if (nResult == 2)
        {
            ...
            // Provide some feedback formatted to the games method of showing immunity feedback
            // Only certain saving throw types check immunities.
            int nImmunityType = -1;
            switch(nSaveType)
            {
...
void SendImmunityFeedback(object oCaster, object oTarget, int nImmunityType)
{
    ...
    {
        case IMMUNITY_TYPE_ABILITY_DECREASE:            nStrRef = 0; break;
        case IMMUNITY_TYPE_AC_DECREASE:                 nStrRef = 0; break;
        case IMMUNITY_TYPE_ATTACK_DECREASE:             nStrRef = 0; break;
        ...
        case IMMUNITY_TYPE_DAMAGE_DECREASE:             nStrRef = 0; break;
        case IMMUNITY_TYPE_DAMAGE_IMMUNITY_DECREASE:    nStrRef = 0; break;
        ...
        case IMMUNITY_TYPE_MOVEMENT_SPEED_DECREASE:     nStrRef = 0; break;
        case IMMUNITY_TYPE_NEGATIVE_LEVEL:              nStrRef = STRREF_IMMUNITY_NEGATIVE_LEVELS; break;
        case IMMUNITY_TYPE_NONE:                        nStrRef = 0; break;
        ...
        case IMMUNITY_TYPE_SAVING_THROW_DECREASE:       nStrRef = 0; break;
        case IMMUNITY_TYPE_SILENCE:                     nStrRef = STRREF_IMMUNITY_SILENCE; break;
        case IMMUNITY_TYPE_SKILL_DECREASE:              nStrRef = 0; break;
        ...
        case IMMUNITY_TYPE_SPELL_RESISTANCE_DECREASE:   nStrRef = 0; break;
        case IMMUNITY_TYPE_STUN:                        nStrRef = STRREF_IMMUNITY_STUN; break;
        case IMMUNITY_TYPE_TRAP:                        nStrRef = 0; break;
    }

    // Invalid type for immunity feedback we stop; Bioware didn't provide feedback on several of them (besides in spell scripts a VFX).
    if (nStrRef == 0) return;
