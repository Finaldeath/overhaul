...
// * if not runnning normal or better Ai then exit for performance reasons
    ...
    //On seen a PC - add the proper journal quest entry to the PC
    if (GetIsPlayerCharacter(oPercep) == TRUE)
    {
       /*if (GetLocalInt(oPercep, "NW_JOURNAL_ENTRYq1foot_horns") == 0)
       {
            //AddJournalQuestEntry("q1footstag", 5, oPercep);
       } */
    }
