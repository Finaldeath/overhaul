...
//:://////////////////////////////////////////////
/*
    Use a healing kit on Dying Man
*/
//:://////////////////////////////////////////////
...
void main()
{
    ...
    DelayCommand(2.0, RemoveEffect(oMan, eEffect));
    SetLocalInt(oMan, "nCured", 1);
    AssignCommand(oPC, ActionMoveToObject(oMan));
    DelayCommand(0.5, AssignCommand(oPC, ActionPlayAnimation(ANIMATION_LOOPING_GET_LOW,1.0, 1.5)));
    ...
    DelayCommand(5.0, ApplyEffectToObject(DURATION_TYPE_INSTANT, eLink, oMan));
