...
// first time speaking to any of the slaves AND the PC has made peaceful passage with the gnolls
// OR the PC has taken control of the gnoll tribe
...
int StartingConditional()
{
    ...
    return (nKnow == 0 && (nStatus == GNOLL_STATUS_SAFE_PASSAGE || nStatus == GNOLL_STATUS_CONTROL_TRIBE));
}
