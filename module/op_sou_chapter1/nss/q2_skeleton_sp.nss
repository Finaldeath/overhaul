...
//:: X0_C2_SPWN_DEF
/*
 * CHANGES BY YARON: spawn skeleton with a summon effect.
...
void main()
{
    ...
    */
    ...
    if(!GetIsEncounterCreature())
    {
        ...
        DelayCommand(0.3, ApplyEffectToObject(DURATION_TYPE_INSTANT, eVis, OBJECT_SELF));
        object oPC = GetNearestCreature(CREATURE_TYPE_PLAYER_CHAR, PLAYER_CHAR_IS_PC);
        DelayCommand(0.3, ActionAttack(oPC));
    }
