// Action taken for Gishnak: player gets full control of the tribe
...
void main()
{
    SetLocalInt(GetModule(), "Q3_GNOLL_STATUS", GNOLL_STATUS_CONTROL_TRIBE);
    object oGnoll = GetObjectByTag("Q3_GNOLL_FACTION"); // use this object to adjust the reputation of all other gnolls
    AdjustReputation(GetPCSpeaker(), oGnoll, 50);
    AdjustReputation(oGnoll, GetPCSpeaker(), 50);
