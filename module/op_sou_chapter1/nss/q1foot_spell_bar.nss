...
void main()
{
    ...
    if ((nSpell == SPELL_CURE_LIGHT_WOUNDS || nSpell == SPELL_CURE_MINOR_WOUNDS || nSpell == SPELL_CURE_MODERATE_WOUNDS || nSpell == SPELL_CURE_SERIOUS_WOUNDS || nSpell == SPELL_CURE_CRITICAL_WOUNDS || nSpell == SPELLABILITY_LAY_ON_HANDS) && GetLocalInt(OBJECT_SELF, "nHealed") != 1)
    {
