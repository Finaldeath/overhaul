//::///////////////////////////////////////////////
//:: Name q3b_spell_airped
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
    On spell cast at for Air Pedestal in Wizard's dungeon
    ...
    If you cast any other cantrip other than 'Acid Splash', a message
    "That spell does nothing." appears.  If 'Electric Jolt' is cast,
    ...
    if (GetLocalInt(oArea, "nGotPedToken") != 1)
    {
        ...
        if (nSpell < 464 || nSpell > 471)
        {
            ...
            if (GetIsCantrip(nSpell) == TRUE)
            {
                ...
                //wrong choice
                else if (nSpell == SPELL_ELECTRIC_JOLT)
                {
                    //message to PC
