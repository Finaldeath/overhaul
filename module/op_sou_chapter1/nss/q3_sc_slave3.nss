...
// not the first time speaking to one of the slaves AND the PC has control over the tribe
// AND the module variable "q3_Slave_Hate" is set to 1
...
int StartingConditional()
{
    ...
    return (nKnow != 0 && nStatus == GNOLL_STATUS_CONTROL_TRIBE && nHate == 1);
}
