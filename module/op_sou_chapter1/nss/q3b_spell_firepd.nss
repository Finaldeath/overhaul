//::///////////////////////////////////////////////
//:: Name q3b_spell_firepd
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
    On spell cast at for Fire Pedestal in Wizard's dungeon
    ...
    If you cast any other cantrip other than 'Ray of Frost', a message
    "That spell does nothing." appears.  If 'Flare' is cast,
    ...
    if (GetLocalInt(oArea, "nGotPedToken") != 1)
    {
        ...
        if (nSpell < 464 || nSpell > 471)
        {
            ...
            if (GetIsCantrip(nSpell) == TRUE)
            {
                ...
                //wrong choice
                else if (nSpell == SPELL_FLARE)
                {
                    //message to PC
                    FloatingTextStrRefOnCreature(40489,oPC);
                    //Destroy fire trigger to kill the vfx
                    object oTrigger = GetObjectByTag("q3b_pedfiretrigger");
