    ...
    for (nComboNumber=1; nComboNumber <= nNumberOfCombos; nComboNumber++)
    {
        ...
        switch (nComboNumber)
        {
            ...
            case 1:
                ...
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber, "NW_IT_MSMLMISC09");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber, "NW_IT_MSMLMISC12");

                // * the reward is   Fenberry
            ...
            case 2:
                ...
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber, "NW_IT_MSMLMISC10");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber, "NW_IT_MSMLMISC12");
            ...
            case 3:
                ...
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber, "NW_IT_MSMLMISC08");
            ...
            case 4:
                ...
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber, "NW_IT_MSMLMISC06");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber, "NW_IT_MSMLMISC06");
            ...
            case 5:
                ...
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber, "NW_IT_MSMLMISC06");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber, "NW_IT_MSMLMISC14");
...
void CreateLabItem(int nSpellID)
{
    ...
    //SpeakString(IntToString(nCombo));
...
//    SpeakString("CreateLabItem " + sItem);
