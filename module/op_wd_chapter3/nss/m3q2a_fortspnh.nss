...
void main()
{
    ...
    if (CountFactionMembers(OBJECT_SELF) < 5)
    {
        object oDoor = GetNearestObjectByTag("Barracks2");
        AssignCommand(oDoor, ActionOpenDoor(oDoor));
        CreateObject(OBJECT_TYPE_CREATURE,"M3Q2_FORTSOLDIE2",GetLocation(OBJECT_SELF));
    }
}
