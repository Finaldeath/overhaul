...
//:://////////////////////////////////////////////
/*
     take hide, give cloak to pc, set Forester's voting
     for PC, give xp, set Manticore hunt over
*/
//:://////////////////////////////////////////////
...
//    ActionTakeItem(oHide,oPC);
    ...
    CreateItemOnObject("os_hunterscloak",oPC);
    SetLocalInt(GetModule(), "os_manticorehunt",99);
}
