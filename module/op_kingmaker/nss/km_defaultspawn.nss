...
void main()
{
    ...
    */
    ...
    //K2 - Hammer Fix, to prevent people getting dominated - 2/2/2005
    effect eMindEffect = EffectImmunity(IMMUNITY_TYPE_MIND_SPELLS);
    ApplyEffectToObject(DURATION_TYPE_PERMANENT, eMindEffect, OBJECT_SELF);
}
