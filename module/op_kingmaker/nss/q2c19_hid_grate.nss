...
void main()
{
    ...
    if(GetLocalInt(GetModule(), "OS_YENNA_ZEBULON")>0)
    {
           ...
           )
        {
           ...
           if ((nBestSkill +nMod > nDifficulty))
           {
                ...
                oDoor = CreateObject(OBJECT_TYPE_PLACEABLE,"q2c19_hid_grate",lLoc,TRUE);
                ActionSpeakString("This entry is far too small for a human to enter.");
