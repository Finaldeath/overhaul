...
/*
    ...
    or Hidden Wall Door invisible objects.
...
void main()
{
       ...
       )
    {
       ...
       if ((nBestSkill +nMod > nDifficulty))
       {
            ...
            oDoor = CreateObject(OBJECT_TYPE_PLACEABLE,"os_hidden_dwood",lLoc,TRUE);
            //visual effect
            effect eVis = EffectVisualEffect(VFX_DUR_GLOW_LIGHT_GREEN);
            ApplyEffectToObject(DURATION_TYPE_TEMPORARY,eVis,oDoor,10.0f);
            ...
            //creates the magic weapon and starts the conversation
