...
void main()
{
    ...
    int nCount = 1;
    effect eVFXPurple = EffectVisualEffect(VFX_DUR_GLOW_PURPLE);
       ...
       )
    {
       ...
       if ((nBestSkill +nMod > nDiffaculty))
       {
            ...
            AssignCommand(oidDoor, DelayCommand(1.0f, ApplyEffectToObject
                (DURATION_TYPE_TEMPORARY, eVFXPurple, oidDoor, 10.0f)));
