...
void main()
{
    ...
    RewardXP("m2q2_Orlane", 100, oPC, ALIGNMENT_GOOD);

    SetLocalInt(GetModule(),"NW_M2Q2E_LFINDDRUID1",1);
    ActionMoveAwayFromObject(oPC);
    DelayCommand(5.0,ClearAllActions());
    DelayCommand(5.0,JumpToObject(GetWaypointByTag("WP_M2Q2E_ORLANE")));
    DelayCommand(5.0,SetLocalInt(GetModule(),"NW_M2Q2E_LFINDDRUID1",2));
}
