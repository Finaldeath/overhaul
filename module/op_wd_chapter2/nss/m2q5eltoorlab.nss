...
void BadResult()
{
    ...
    effect eFire =  EffectDamage(nDamage,DAMAGE_TYPE_ELECTRICAL);
...
void SetupLab()
{
  ...
  */
    ...
    SetLocalString(GetModule(),"NW_MYCHESTTAG","M2Q1ELTOORACHEST");
    ...
    */
    ...
    for (nComboNumber=1; nComboNumber <= nNumberOfCombos; nComboNumber++)
    {
        ...
        switch (nComboNumber)
        {
            ...
            case 1:
                SetLocalArrayInt(OBJECT_SELF,"NW_COMBO_SPELL",nComboNumber,SPELL_IMPROVED_INVISIBILITY);
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber,"NW_IT_MSMLMISC07");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber,"NW_IT_MSMLMISC13");

                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REWARD",nComboNumber,"NW_IT_MRING018");
            break;
            // * Amulet of Natural Armor +3
            case 2:
                SetLocalArrayInt(OBJECT_SELF,"NW_COMBO_SPELL",nComboNumber,SPELL_MAGE_ARMOR);
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber,"NW_IT_MSMLMISC11");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber,"NW_IT_MSMLMISC13");

                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REWARD",nComboNumber,"NW_IT_MNECK013");
            break;
            // * Staff of Power
            case 3:
                SetLocalArrayInt(OBJECT_SELF,"NW_COMBO_SPELL", nComboNumber,SPELL_FIREBALL);
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber,"NW_IT_MSMLMISC08");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber,"NW_IT_MSMLMISC11");

                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REWARD",nComboNumber,"NW_WMGST005");
            break;
            // * Wand of Lightning
            case 4:
                SetLocalArrayInt(OBJECT_SELF,"NW_COMBO_SPELL", nComboNumber,SPELL_LIGHTNING_BOLT);
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber,"NW_IT_MSMLMISC07");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber,"NW_IT_MSMLMISC12");

                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REWARD",nComboNumber,"NW_WMGWN007");
            break;
            // * Ring of Protection +3
            case 5:
                SetLocalArrayInt(OBJECT_SELF,"NW_COMBO_SPELL", nComboNumber,SPELL_ENDURE_ELEMENTS);
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber,"NW_IT_MSMLMISC11");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber,"NW_IT_MSMLMISC12");

                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REWARD",nComboNumber,"NW_IT_MRING002");
            break;
...
int GetCombo(int nSpellID)
{
    ...
    else
    {
        ...
        if (nArrayPosition != -1)
        {
            ...
            string sArrayReagent2 = GetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2", nArrayPosition);
...
void CreateLabItem(int nSpellID)
{
    ...
    if (nCombo != -1)
    {
        ...
        ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_ELEMENTAL_PROTECTION),OBJECT_SELF);
        DelayCommand(1.5,ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_FLAME_M),OBJECT_SELF));
    }
    else
    {
