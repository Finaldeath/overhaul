...
void main()
{
    int nUsed = GetLocalInt(OBJECT_SELF, "NW_2Q4_USED_WIND_LEVER");
    object oItem = GetItemPossessedBy(GetLastUsedBy(), "2Q4_LeverWind");
    if(nUsed == 0 && GetIsObjectValid(oItem))
    {
        object oSpawn;
        object oItem = GetItemPossessedBy(GetLastUsedBy(), "2Q4_LeverWind");
        object oPed = GetObjectByTag("2Q4_AirPed");
        ...
        if(GetIsObjectValid(oItem))
        {
            ...
            oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "2Q4_AirLever", lStone);
            nPlot++;
        ...
        SetLocalInt(OBJECT_SELF,"NW_2Q4_USED_WIND_LEVER" ,1);
    }
}
