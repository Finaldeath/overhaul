...
void SetupLab()
{
  ...
  */
    ...
    SetLocalString(GetModule(),"NW_MYCHESTTAG","M2Q05PELMINLAB");
    ...
    */
    ...
    for (nComboNumber=1; nComboNumber <= nNumberOfCombos; nComboNumber++)
    {
        ...
        switch (nComboNumber)
        {
            // * Rod of Reversal
            case 1:
                SetLocalArrayInt(OBJECT_SELF,"NW_COMBO_SPELL", nComboNumber, SPELL_DISPEL_MAGIC);
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_1",nComboNumber, "NW_IT_MSMLMISC14");
                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REAGENT_2",nComboNumber, "NW_IT_MSMLMISC10");

                SetLocalArrayString(OBJECT_SELF,"NW_COMBO_REWARD",nComboNumber,"NW_WMGMRD005");
            break;
        }
    }
