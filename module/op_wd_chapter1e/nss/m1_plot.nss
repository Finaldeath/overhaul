...
void GiveMonkTreasure(object oMonk)
{
    string sItem;
    if(GetIsObjectValid(GetItemPossessedBy(oMonk,"NW_IT_MBOOTS020")))// Boots of the sunsoul +3
    {
        sItem = "nw_it_mpotion003";
    }
    else if(GetIsObjectValid(GetItemPossessedBy(oMonk,"NW_MCLOTH015"))) //robes of the old order
    {
        sItem = "nw_it_mboots020";
    }
    else if(GetIsObjectValid(GetItemPossessedBy(oMonk,"NW_IT_MBOOTS019")))// boots of the sun soul +2
    {
        sItem = "nw_mcloth015";
    }
    else if(GetIsObjectValid(GetItemPossessedBy(oMonk,"NW_MCLOTH019")))//robe of the shining order +2
    {
        sItem = "nw_it_mboots019";
    }
    else
    {
        sItem = "nw_mcloth019";
