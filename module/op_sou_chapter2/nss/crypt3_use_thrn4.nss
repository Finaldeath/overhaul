//::///////////////////////////////////////////////
//:: Name  crypt3_use_thrn4
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
    On used - PC sits in throne - if someone is
    also sitting in the matching throne (crypt03_chair3),
...
void main()
{
    ...
    {
        object oChair3 = GetObjectByTag("crypt03_chair3");
        if (GetIsObjectValid(GetSittingCreature(oChair3)) == TRUE)
        {
            //Spawn in the monster
            SetLocalInt(OBJECT_SELF, "nSpawned", 1);
            SetLocalInt(oChair3, "nSpawned", 1);
