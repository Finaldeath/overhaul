//::///////////////////////////////////////////////
//:: Name  crypt3_use_thrn1
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
    On used - PC sits in throne - if someone is
    also sitting in the matching throne (crypt03_chair2),
    spawn in a Shadow Fiend (nw_shfiend) at the matching
    waypoint(wp_crypt3_throne12_spn).
...
void main()
{
    ...
    {
        object oChair2 = GetObjectByTag("crypt03_chair2");
        if (GetIsObjectValid(GetSittingCreature(oChair2)) == TRUE)
        {
            //Spawn in the monster
            SetLocalInt(OBJECT_SELF, "nSpawned", 1);
            SetLocalInt(oChair2, "nSpawned", 1);
            location lTarget = GetLocation(GetWaypointByTag("wp_crypt3_throne12_spn"));
