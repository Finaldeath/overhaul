//::///////////////////////////////////////////////
//:: Name  crypt3_use_thrn2
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
    On used - PC sits in throne - if someone is
    also sitting in the matching throne (crypt03_chair1),
...
void main()
{
    ...
    {
        object oChair1 = GetObjectByTag("crypt03_chair1");
        if (GetIsObjectValid(GetSittingCreature(oChair1)) == TRUE)
        {
            //Spawn in the monster
            SetLocalInt(OBJECT_SELF, "nSpawned", 1);
            SetLocalInt(oChair1, "nSpawned", 1);
