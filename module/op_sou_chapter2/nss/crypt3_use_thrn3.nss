//::///////////////////////////////////////////////
//:: Name  crypt3_use_thrn3
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
    On used - PC sits in throne - if someone is
    also sitting in the matching throne (crypt03_chair4),
    spawn in a Shadow Fiend (nw_shfiend) at the matching
    waypoint(wp_crypt3_throne34_spn).
...
void main()
{
    ...
    {
        object oChair4 = GetObjectByTag("crypt03_chair4");
        if (GetIsObjectValid(GetSittingCreature(oChair4)) == TRUE)
        {
            //Spawn in the monster
            SetLocalInt(OBJECT_SELF, "nSpawned", 1);
            SetLocalInt(oChair4, "nSpawned", 1);
            location lTarget = GetLocation(GetWaypointByTag("wp_crypt3_throne34_spn"));
