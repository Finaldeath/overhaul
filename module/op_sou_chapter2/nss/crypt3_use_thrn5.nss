//::///////////////////////////////////////////////
//:: Name  crypt3_use_thrn5
//:: Copyright (c) 2001 Bioware Corp.
//:://////////////////////////////////////////////
/*
    On used - PC sits in throne - if someone is
    also sitting in the matching throne (crypt03_chair6),
...
void main()
{
    ...
    {
        object oChair6 = GetObjectByTag("crypt03_chair6");
        if (GetIsObjectValid(GetSittingCreature(oChair6)) == TRUE)
        {
            //Spawn in the monster
            SetLocalInt(OBJECT_SELF, "nSpawned", 1);
            SetLocalInt(oChair6, "nSpawned", 1);
