...
void main()
{
    ...
    //Have skeleton worship
    if (GetLocalInt(OBJECT_SELF, "nWorshiping") != 1)
    {
        SetLocalInt(OBJECT_SELF, "nWorshiping", 1);
        ActionPlayAnimation(ANIMATION_LOOPING_WORSHIP, 1.0, 10000.0);
        DelayCommand(10000.0, SetLocalInt(OBJECT_SELF, "nWorshiping", 0));
    }
}
