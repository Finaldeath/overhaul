...
void main()
{
    ...
    if(nUser == 1001) //HEARTBEAT
    {
        ...
        && !IsInConversation(OBJECT_SELF))
        {
            ...
            {
                ActionMoveToLocation(GetLocation(GetWaypointByTag("q2edeerspawn")));
            }
        }
    }
    ...
    else if(nUser == 1007) // DEATH
    {
        ...
        {
            //Spawn in a new wolf to replace the dead one..
            CreateObject(OBJECT_TYPE_CREATURE, "q2ewolf", GetLocation(GetWaypointByTag("q2ewolfspawn")));
