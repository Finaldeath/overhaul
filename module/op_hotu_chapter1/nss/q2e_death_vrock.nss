...
void MakeCreature(string sCreature, location lTarget)
{
...
void main()
{
    ...
    ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_FNF_IMPLOSION), lTarget);
    DelayCommand(2.0, MakeCreature("q2egeaozil", lTarget));
