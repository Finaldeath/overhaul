...
void main()
{
    ...
    if (nEvent == 19767) //Follower kicked out of party because PC jumped to another zone
    {
        //set a variable for conversation so follower knows to rejoin.
        SetLocalInt(OBJECT_SELF, "nWaitForPCToReturn", 1);
    }
