...
void CreateDoor(object oPC)
{
    ...
    ApplyEffectAtLocation(DURATION_TYPE_INSTANT, EffectVisualEffect(471), lTarget);
    ...
    DelayCommand(1.0, AssignCommand(oNewDoor, ActionStartConversation(oPC, "con_hod_ldoor")));
}
