...
////////////////////////////////////////////////////////////////////////
     ...
     CutActionCastFakeSpellAtLocation(7.1, SPELL_INFERNO, oWiz1, lGood1, PROJECTILE_PATH_TYPE_DEFAULT);
     CutApplyEffectAtLocation(9.3, oPC, DURATION_TYPE_INSTANT, VFX_FNF_FIRESTORM, lGood1, 0.0);
     ...
     CutSetActiveCutsceneForObject(GetObjectByTag("Cut10_Ballista1_o"), nCutsceneNumber);
     CutPlayAnimation(14.0, GetObjectByTag("Cut10_Ballista1_o"), ANIMATION_LOOPING_GET_MID,
                      2.0);
     ...
     CutSetCamera(21.0, oPC, CAMERA_MODE_TOP_DOWN, 35.0, 17.0, 1.0,
                  CAMERA_TRANSITION_TYPE_SLOW);
     // Launch the ballista.  Apply animation to its operator.
     CutPlayAnimation(24.0, GetObjectByTag("Cut10_Ballista1_o"), ANIMATION_LOOPING_GET_MID, 2.0);
     ...
     CutSetCamera(31.0, oPC, CAMERA_MODE_TOP_DOWN, 35.0, 17.0, 1.0, CAMERA_TRANSITION_TYPE_FAST);
     ...
     CutPlayAnimation(29.0, GetObjectByTag("cut10_cat2_o"), ANIMATION_LOOPING_GET_MID, 2.0);
     ...
     // statue
     DelayCommand(32.4,
        ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDamage(100), GetObjectByTag("cut10_statue1")));
     // Create a broken statue in place of the old one.
     CutCreateObject(32.5, oPC, OBJECT_TYPE_PLACEABLE, "cut10_statue1_b", lStatue1, 0);
     ...
     CutApplyEffectAtLocation(33.0, oPC, DURATION_TYPE_INSTANT, VFX_FNF_FIREBALL,
                              lBarrel1, 0.0);
     DelayCommand(33.0, ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDamage(100), GetObjectByTag("cut10_barrel1")));
     // Create a broken barrel in place of the old one.
     CutCreateObject(33.1, oPC, OBJECT_TYPE_PLACEABLE, "cut10_barrel1_b", lBarrel1, 0);
     ...
     CutApplyEffectAtLocation(33.6, oPC, DURATION_TYPE_INSTANT, VFX_FNF_FIREBALL,
                              lBarrel2, 0.0);
     DelayCommand(33.6, ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDamage(100), GetObjectByTag("cut10_barrel2")));
     // Create a broken barrel in place of the old one.
     CutCreateObject(33.7, oPC, OBJECT_TYPE_PLACEABLE, "cut10_flame1", lBarrel2, 0);
     CutCreateObject(33.7, oPC, OBJECT_TYPE_PLACEABLE, "cut10_barrel2_b", lBarrel2, 0);

     CutApplyEffectAtLocation(34.2, oPC, DURATION_TYPE_INSTANT, VFX_FNF_SCREEN_SHAKE, lCatapult2_Target, 0.0);

     // cart
     CutApplyEffectAtLocation(34.2, oPC, DURATION_TYPE_INSTANT, VFX_FNF_FIREBALL, lCart, 0.0);
     DelayCommand(34.2,
        ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDamage(100), GetObjectByTag("cut10_cart")));
     ...
     DelayCommand(35.4,
        ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_FLAME_M), GetObjectByTag("cut10_militia_f")));
     DelayCommand(35.5,
        ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDamage(9999), GetObjectByTag("cut10_militia_f")));

     CutSetCamera(31.3, oPC, CAMERA_MODE_TOP_DOWN, 15.0, 5.0, 10.0, CAMERA_TRANSITION_TYPE_FAST);
     CutSetCamera(32.2, oPC, CAMERA_MODE_TOP_DOWN, 135.0, 6.0, 70.0, CAMERA_TRANSITION_TYPE_FAST);
     ...
     CutActionCastFakeSpellAtLocation(42.0, SPELL_HORRID_WILTING, oWiz1,
                                      lGood1,
                                      PROJECTILE_PATH_TYPE_DEFAULT);
     CutApplyEffectAtLocation(44.7, oPC, DURATION_TYPE_INSTANT, VFX_FNF_HORRID_WILTING,
                              lGood1, 0.0);

     DelayCommand(45.8,
        ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDamage(9999), GetObjectByTag("cut10_militia_f2")));
     CutActionCastFakeSpellAtLocation(47.0, SPELL_NATURES_BALANCE, oWiz1,
                                      lGood1,
                                      PROJECTILE_PATH_TYPE_DEFAULT);
     CutApplyEffectAtLocation(49.9, oPC, DURATION_TYPE_INSTANT, VFX_FNF_NATURES_BALANCE, lGood1, 0.0);
     ...
     CutApplyEffectAtLocation(52.5, oPC, DURATION_TYPE_INSTANT, VFX_FNF_LOS_EVIL_30,
                              lGood8, 0.0);
     CutApplyEffectToObject(52.6, DURATION_TYPE_TEMPORARY, VFX_DUR_ELEMENTAL_SHIELD, GetObjectByTag("Cut10_Ram_o"), 20.0);
     ...
     DelayCommand(56.0,
        AssignCommand(GetObjectByTag("cut10_drow_run"), ActionMoveToLocation(lRun1, TRUE)));

     CutActionMoveToLocation(60.0, oPC, lStop6, TRUE);

     DelayCommand(60.0,
        AssignCommand(GetObjectByTag("cut10_drow_run"), ActionMoveToLocation(lRun2, TRUE)));
     ...
     DelayCommand(72.8,
        AssignCommand(GetObjectByTag("cut10_duer_end2"), ActionPlayAnimation(ANIMATION_FIREFORGET_VICTORY2, 0.0)));
     DelayCommand(73.0,
        AssignCommand(GetObjectByTag("cut10_duer_end2"), SpeakStringByStrRef(83947)));
...
// Reset the telescope
void SetTelescope(object oPC) {
       if(GetLocalInt(GetModule(), "nCut" + IntToString(GetLocalInt(oPC, "nCutsceneNumber")) + "Skipped") != 1)
