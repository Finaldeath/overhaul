...
/*
    ...
    //q2c_hb_secretdr
     - don't let secret door trigger until after the level entry cutscene
...
void main()
{
    //Can't find this door till after the Level 2 Entry cutscene plays
    object oArea = GetArea(OBJECT_SELF);
    if (GetLocalInt(oArea, "X2_CutScene39") == 0)
        return;
       ...
       )
    {
       ...
       if ((nBestSkill +nMod > nDiffaculty))
       {
            ...
            if (GetLocalInt(GetModule(),"X2_SWITCH_DISABLE_SECRET_DOOR_FLASH") == FALSE)
            {
                ...
                ApplyEffectToObject(DURATION_TYPE_TEMPORARY,eVis,oidDoor,0.0f);
            }
