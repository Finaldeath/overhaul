...
void main()
{
    SetLocalString(GetArea(OBJECT_SELF), "NW_GAREA_GONGPUZZLE_1", "123");
    ...
    DelayCommand(1.0,AssignCommand(GetObjectByTag("M4Q1C07_GONG_1"),ActionSpeakStringByStrRef(57985)));
    if (GetIsObjectValid(oSound2) == TRUE)
    {
        DelayCommand(2.0,SoundObjectPlay(oSound2));
    }
    DelayCommand(2.0,AssignCommand(GetObjectByTag("M4Q1C07_GONG_2"),ActionSpeakStringByStrRef(57985)));
