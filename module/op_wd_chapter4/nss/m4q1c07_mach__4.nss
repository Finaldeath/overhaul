...
void main()
{
    SetLocalString(GetArea(OBJECT_SELF), "NW_GAREA_GONGPUZZLE_4", "312");
    ...
    DelayCommand(5.0,AssignCommand(GetObjectByTag("M4Q1C07_GONG_2"),ActionSpeakStringByStrRef(57985)));
